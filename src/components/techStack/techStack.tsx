...
// const Sparkles = dynamic(() => import("../techStack/sparkles"), { ssr: false });

// export function CardDemo() {
//   return (
//     <Card className="dark:bg-black drop-shadow-[0_0_20px_rgba(128,90,213,0.5)]">

//       <CardSkeletonContainer>
//         <Skeleton />
//       </CardSkeletonContainer>
//       <CardTitle>Advanced Tool to Excel</CardTitle>
//       <CardDescription>
//         Seamless Development with AI-Powered Tools
//       </CardDescription>
//     </Card>
//   );
// }
...
//   }, []);
//   return (
//     <div className="p-8 overflow-hidden h-full relative flex items-center justify-center bg-slate-900">
...
import React, { useEffect } from "react";
import { cn } from "@/lib/utils";
import {  SiMongodb, SiReact, SiNextdotjs, SiTailwindcss } from "react-icons/si";
const Sparkles = dynamic(() => import("../techStack/sparkles"), { ssr: false });
...
const Skeleton = () => {
  ...
  return (
    <div className="p-8 overflow-hidden h-full relative flex items-center justify-center bg-slate-900">
      <div className="flex flex-row shrink-0 justify-center items-center gap-2 ">
        {/* <Container className="h-8 w-8 circle-1">
          <SiVisualstudiocode className="h-4 w-4 dark:text-white" />
        </Container> */}
        <Container className="h-12 w-12 circle-2">
          <SiMongodb className="h-6 w-6 dark:text-white" />
        </Container>
        <Container className="circle-3">
          <SiReact className="h-8 w-8 dark:text-white" />
        </Container>
        <Container className="h-12 w-12 circle-4">
          <SiNextdotjs className="h-6 w-6 dark:text-white" />
        </Container>
        <Container className="h-8 w-8 circle-5">
          <SiTailwindcss className="h-4 w-4 dark:text-white" />
        </Container>
      </div>
